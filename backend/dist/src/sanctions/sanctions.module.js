...
const sanctions_controller_js_1 = require("./sanctions.controller.js");
...
exports.SanctionsModule = SanctionsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [sanctions_controller_js_1.SanctionsController],
        providers: [sanctions_service_js_1.SanctionsService],
        exports: [sanctions_service_js_1.SanctionsService],
    })
], SanctionsModule);
